    ...
    <div class="footer__grid">
      ...
      <div>
        ...
        <div class="footer__contact-item">
          ...
          <a href="<?php echo esc_url( get_theme_mod( 'db_contact_link_url' ) ); ?>" target="_blank" rel="noopener"><?php echo esc_html( get_theme_mod( 'db_contact_link_title' ) ? get_theme_mod( 'db_contact_link_title' ) : get_theme_mod( 'db_contact_link_url' ) ); ?></a>
        </div>
        <?php endif; ?>
      </div>
    </div>
