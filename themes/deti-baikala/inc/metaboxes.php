...
db_register_page_template_metabox(
	...
	array(
		...
		array( 'key' => '_ns_feat1_icon',  'label' => __( 'Особенность 1: иконка (из медиатеки)', 'deti-baikala' ), 'type' => 'media' ),
		...
		array( 'key' => '_ns_feat2_icon',  'label' => __( 'Особенность 2: иконка (из медиатеки)', 'deti-baikala' ), 'type' => 'media' ),
		...
		array( 'key' => '_ns_feat3_icon',  'label' => __( 'Особенность 3: иконка (из медиатеки)', 'deti-baikala' ), 'type' => 'media' ),
		...
		array( 'key' => '_ns_feat4_icon',  'label' => __( 'Особенность 4: иконка (из медиатеки)', 'deti-baikala' ), 'type' => 'media' ),
