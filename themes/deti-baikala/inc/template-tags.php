...
function db_get_social_icon_svg( $icon ) {
	$icons = array(
		...
		'max'      => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2 4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H2zm2 3h2.5l1.5 2.4L9.5 7H12L9 12l3 5H9.5L8 14.6 6.5 17H4l3-5-3-5zm9 0h4a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-4V7zm2 2v6h2V9h-2z"/></svg>',
