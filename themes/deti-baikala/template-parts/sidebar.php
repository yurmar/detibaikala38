 ...
 * reports/reviews/media/single новости). Виджет-зона "sidebar-page" используется
 * для дополнительных блоков (реклама и т.д.), добавляемых через WP-admin.
 */
?>
<aside class="sidebar">
        ...
        while ( $recent->have_posts() ) :
            ...
            <div class="sidebar-news-item">
              ...
              <div class="sidebar-news-item__text">
                ...
                <div class="sidebar-news-item__date"><?php echo esc_html( get_the_date( 'd.m.Y' ) ); ?></div>
              </div>
            </div>
            <?php
        endwhile;
  ...
  <?php // ── Активные сборы (Лейка) ───────────────────────────────── ?>
  <?php if ( function_exists( 'db_leyka_active' ) && db_leyka_active() ) : ?>
  <div class="sidebar-widget">
    ...
    while ( $campaigns->have_posts() ) :
        ...
        <div class="sidebar-campaign">
          <div class="sidebar-campaign__title">
            <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
          </div>
